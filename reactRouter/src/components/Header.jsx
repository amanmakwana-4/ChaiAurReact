...
export default function Header() {
    return (
        <header className="shadow sticky z-50 top-0 bg-gray-600 text-white">
            <nav className="border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        {/* ❗ CHANGED: '/started' → '/get-started' */}
                        <Link
                            to="/get-started"     // ✅ FIXED
                    ...
                    <div
                        ...
                        id="mobile-menu-2"
                    >
                        {/* ⚠ NOTE: This menu is hidden on mobile because there is NO toggle button.
                           If you want a hamburger menu, I can add it. */}
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <NavLink
                                    to='/github-profile'   // already correct
                                    className={({ isActive }) =>
                                        `block py-2 pr-4 pl-3 duration-200 ${
                                            isActive ? "text-orange-700" : "text-gray-700"
                                        } border-b border-gray-100 hover:bg-gray-50 
